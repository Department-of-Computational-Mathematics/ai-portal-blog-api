...
@router.get("/blog/{blog_id}", tags=["Blog", "Unauthenticated"])
...
@router.post('/createblog', response_model=BlogPost, tags=["Blog", "Authenticated"])
...
@router.put('/updateblog/{id}', response_model=BlogPost, tags=["Blog", "Authenticated"])
...
@router.post('/write-comment', response_model=Comment, tags=["Blog-Comment", "Authenticated"])
...
@router.post('/reply-comment', response_model=Reply, tags=["Blog-Comment", "Authenticated"])
...
@router.get('/blogs', response_model=List[BlogPost], tags=["Blog", "Unauthenticated"])
async def getAllBlogs():
    return await get_all_blogs()

@router.delete('/blogs/{id}', tags=["Blog", "Authenticated"])
...
@router.get('/blogsByTags',response_model=List[BlogPost], tags=["Blog", "Unauthenticated"])
...
@router.get('/blog/{id}/comments', response_model=List[Comment], tags=["Blog-Comment", "Unauthenticated"])
async def get_comments_and_replies(id:str):
    return await fetch_comments_and_replies(id)

@router.put('/edit-comment-reply/{id}', response_model=Union[Comment, Reply], tags=["Blog-Comment", "Authenticated"])
...
@router.delete('/delete-comment-reply/{id}', tags=["Blog-Comment", "Authenticated"])
